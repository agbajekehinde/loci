...
const HeroSection = () => {
  return (
    <>
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden py-10 dark:bg-[var(--background)] transition-colors duration-300">
        {/* Overlay for readability */}
        <div className="dark:bg-[var(--background)] transition-colors duration-300" />
          ...
          <div className="space-y-8 w-full">
            ...
            <div className="grid sm:grid-cols-2 gap-4 justify-center">
              ...
              <div className="flex items-center space-x-3 justify-center">
                ...
                <span className="text-white font-semibold drop-shadow">36 States with FCT coverage</span>
              </div>
              <div className="flex items-center space-x-3 justify-center">
                <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
      ...
      {/* Hero Image Section */}
      <section className="dark:bg-[var(--background)] transition-colors duration-300">
